...
![](images/spotify_icon.png){fig-align="center" width="267"}
...
$$
LD1​=w1​(energy)+w2​(acousticness)+w3​(danceability)+w4​(speechiness)+w5​(instrumental.)
$$
...
run_fda_model <- function(training_data, test_data, target_column_name, cv_folds = 10, seed = 123) {
  ...
  # Creating model formuala
  formula <- stats::as.formula(paste(target_column_name, "~ ."))

  # Fitting FDA model on full training data
  ...
  # Initializing vector to store accuracy after each fold
